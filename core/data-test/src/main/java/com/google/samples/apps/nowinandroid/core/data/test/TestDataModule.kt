...
import com.google.samples.apps.nowinandroid.core.data.repository.DefaultVideoNewsRepository
...
interface TestDataModule {
    ...
    @Binds
    fun bindsVideoNewsRepository(
        videoNewsRepository: DefaultVideoNewsRepository
    ): VideoNewsRepository
