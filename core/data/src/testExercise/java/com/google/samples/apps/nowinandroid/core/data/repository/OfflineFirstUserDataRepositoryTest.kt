...
class OfflineFirstUserDataRepositoryTest {
    ...
    // TODO: setupでTemporaryFolderをつかって、niaPreferencesDataSourceのインスタンスを作る
    // DataStoreFactory作成時のSerializerにはUserPreferencesSerializerを指定する

    @Before
    fun setup() {
        repository = OfflineFirstUserDataRepository(niaPreferencesDataSource)
    }
