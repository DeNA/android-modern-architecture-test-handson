...
class OnMemoryCacheVideoNewsRepositoryTest {
    ...
    fun `getVideoNewsResources_不必要なAPIリクエストが行われていないかをテストする`() = runTest {
        ...
        // TODO: TestNetworkDataSource#getVideoNewsResources呼び出し回数をカウントする
        ...
        // TODO: TestNetworkDataSource#getVideoNewsResources呼び出し回数が1回であることを確認する
    }
