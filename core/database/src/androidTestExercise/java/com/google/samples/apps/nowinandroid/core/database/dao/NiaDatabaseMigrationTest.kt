...
class NiaDatabaseMigrationTest {
    ...
    /**
     * 練習1: バージョン2からバージョン3までのマイグレーションが正しく行われることを確認するテストを書く。
     *
    ...
    fun migrate2to3() {
        ...
        // TODO バージョン3のデータベースに移行し、移行後のデータベースで、
        //   name、shortDescription、longDescriptionカラムが期待通りの値になっていることを確認するコードを書く。
    }
}
