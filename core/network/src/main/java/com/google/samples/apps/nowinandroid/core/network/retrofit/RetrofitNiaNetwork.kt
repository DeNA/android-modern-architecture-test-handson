...
private interface RetrofitNiaNetworkApi {
    ...
    @GET(value = "newsresources/video")
    suspend fun getVideoNewsResources(): List<NetworkVideoNewsResource>

    @Streaming
    @GET
    suspend fun downloadVideoResource(@Url url : String): ResponseBody
}
...
class RetrofitNiaNetwork @Inject constructor(
    ...
    override suspend fun getVideoNewsResources(): List<NetworkVideoNewsResource> =
        networkApi.getVideoNewsResources()

    override suspend fun downloadVideoResource(url: String): ResponseBody =
        networkApi.downloadVideoResource(url)
}
