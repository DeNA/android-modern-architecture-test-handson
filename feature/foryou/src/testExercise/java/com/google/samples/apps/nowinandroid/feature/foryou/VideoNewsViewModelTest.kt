...
class VideoNewsViewModelTest {
    ...
    @Before
    fun setup() {
        // TODO: Main DispatcherをUnconfinedTestDispatcherで置き換える
    }
    ...
    fun `fetchVideoNewsResources_データ取得の結果、UI Stateが更新されることをテストする`() {
        ...
        // TODO:viewModelのvideoNewsUiState.videoNewsResourcesが
        //  expectedVideoNewsResourcesと一致していることを確認する
    }
    ...
    fun `fetchVideoNewsResources_ViewModel内のエラーハンドリングをテストする`() = runTest {
        ...
        // TODO:viewModelのvideoNewsUiState.errorMessageを検証する
    }
